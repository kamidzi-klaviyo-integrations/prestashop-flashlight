...
1. Obtain a tarball of the PrestaShop sources, `PrestaShop.tgz`
2. `tar xzf PrestaShop.tgz` in project root
3. Copy desired version of klaviyopsautomation module zip archive to `modules`
4. docker compose up
